...
namespace UnityAnimationGraph {
    /// <summary>
    /// Vector4 の直値または Blackboard key 参照
    /// </summary>
    [Serializable]
    public struct Vector4Parameter {
        [SerializeField, Tooltip("値の解決元")]
        private ParameterSource _source;
        [SerializeField, BlackboardKey(AnimationGraphValueType.Vector4), Tooltip("Blackboard の現在値を参照する key")]
        private string _blackboardKey;
        [SerializeField, Tooltip("Vector4 型の直値")]
        ...
        /// <summary>
        /// Vector4 Blackboard 値を参照する Vector4Parameter を生成
        /// </summary>
        /// <param name="blackboardKey">Blackboard key</param>
        /// <param name="relative">基準値からの相対値として扱う場合は true</param>
        /// <returns>生成した Vector4Parameter</returns>
        public static Vector4Parameter Blackboard(string blackboardKey, bool relative = false) {
            return new Vector4Parameter(default) {
        ...
        public bool TryGetValue(IAnimationGraphBlackboard blackboard, out Vector4 value) {
        ...
        /// <summary>
        /// Vector4 値の取得を試行し、相対値の場合は基準値を加算
        /// </summary>
        /// <param name="blackboard">Blackboard 値の取得元</param>
        /// <param name="baseValue">相対値の基準値</param>
        /// <param name="value">取得した値</param>
        /// <returns>取得できた場合は true</returns>
        public bool TryGetValue(IAnimationGraphBlackboard blackboard, Vector4 baseValue, out Vector4 value) {
